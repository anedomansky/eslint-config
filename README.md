...
```
cd existing_repo
git remote add origin https://gitlab.com/anedomansky/eslint-config.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/anedomansky/eslint-config/-/settings/integrations)
